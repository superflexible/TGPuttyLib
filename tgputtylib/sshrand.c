...
#ifdef TGDLL
#define random_active (curlibctx->random_active)
#else
int random_active = 0;
#endif
...
#ifdef TGDLL
#define random_timer_ctx (curlibctx->random_timer_ctx)
#define global_prng (curlibctx->global_prng)
#define next_noise_collection (curlibctx->next_noise_collection)
#else
