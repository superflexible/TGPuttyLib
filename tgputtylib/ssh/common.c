...
#ifdef TGDLL
#define pktin_freeq_head (curlibctx->pktin_freeq_head)
#else
...
NORMALCODE(static) void pktin_free_queue_callback(void *vctx) // TG
{
...
#ifdef TGDLL
#define ic_pktin_free (curlibctx->ic_pktin_free) 
#else
